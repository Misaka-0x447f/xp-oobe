...
const data = {
  itemsGroup: [[
    ['多人性交', '深喉', '口交', '颜射', '乳交', '后入', '内射', '拉珠', '扩张(阴道)', '扩张(肛门)', '拳交(阴道)', '拳交(肛门)', '塞子(小)', '塞子(中)', '塞子(大)', '灌肠', '异物塞入', '食物塞入', '炮机', '电动玩具塞入', '双玩具塞入', '吹潮失禁', '强制高潮', '控制高潮', '拒绝高潮', '多次高潮', '文爱', 'Dirty Talk'],
  ...
  sections: [
    ...
    {
      displayName: '宠物化',
      items: ['k8', 'k9', '马具', '面具', '模仿叫声', '笼子关押', '项圈/镣铐', '饲养(短期)', '饲养(长期)', '被用脚喂食', '宠物式进食', '服务(常规)', '服务(使用嘴)', '爬行', '舔足', '舔鞋', '舔性器官', '踩踏', '出行', '禁言', '坐脸', '坐身体', '插件尾巴']
    },
    {
      displayName: '捆绑/拘束',
